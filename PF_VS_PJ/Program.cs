...
namespace PF_VS_PJ
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (Contributors contributors in list)
            {
                Console.WriteLine(contributors.Name + ": $ " + contributors.Tax().ToString("F2", CultureInfo.InvariantCulture));
                sum += contributors.Tax();
            }
            Console.WriteLine();
